...
class StatusDatabase:
    ...
    def remove_radio(self, radio: Status | None) -> Status | None:
        if radio is None:
            return

        radio = self.by_ip.pop(radio.ip, None)
    ...
    def remove_by_node_id(self, node_id: int) -> Status | None:
        radio = self.by_node_id[node_id]
        return self.remove_radio(radio)
